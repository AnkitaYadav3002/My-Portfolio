...
const projectData = [
  ...
  {
    title: "Bharat Beyond Boundaries – CRM Software",
    tags: [
      "React Native (Expo)",
      "React.js",
      "Tailwind CSS",
    ...
    desc: "Developed a CRM software with a companion mobile application, enabling users to manage customer data and business operations from both web and mobile platforms.",
    features: [
      "Built the mobile application using React Native (Expo) with a shared codebase for Android and iOS",
      "Designed a clean and responsive user interface using React.js and Tailwind CSS",
      "Integrated REST APIs for real-time customer and business data management",
      "Published the Android application on Google Play Store for production deployment",
    ],
    role: "Junior Software Developer",
    timeline: "Feb 2025 – Present",
...
const Projects = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="projects"
      className="py-24 md:py-32 bg-linear-to-b from-[#050505] to-black text-white relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          {projectData.map((project, i) => (
            ...
            >
              <div
                className={`relative p-6 sm:p-8 rounded-2xl bg-linear-to-br ${project.gradient} border border-white/10 transition-all duration-300 hover:border-purple-500/40 hover:shadow-lg hover:shadow-purple-500/5 backdrop-blur-sm`}
              >
                <div className="relative z-10">
                  ...
                  <div className="mt-4 pt-3 border-t border-white/5">
                    <p className="text-[8px] sm:text-[10px] text-gray-600 uppercase tracking-wider">
                      Tech Stack
                    </p>
          ...
          <div className="inline-flex flex-wrap items-center justify-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-white/5 rounded-full border border-white/10">
            ...
            <p className="text-gray-400 text-xs sm:text-sm">
              <strong className="text-purple-400">
                15+ full-stack features
              </strong>{" "}
              developed &
              <strong className="text-purple-400 ml-1">10+ REST APIs</strong>{" "}
